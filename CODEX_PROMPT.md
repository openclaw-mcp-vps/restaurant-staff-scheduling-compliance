...
PROJECT: restaurant-staff-scheduling-compliance
HEADLINE: Ensures restaurant schedules comply with labor laws
WHAT: Validates employee schedules against local labor laws, prevents overtime violations, tracks break requirements, and generates compliance reports
WHY: Labor law violations cost restaurants $8B annually, scheduling software exists but doesn't check compliance automatically
WHO PAYS: Restaurant managers with 10+ employees
...
--------
workdir: /tmp/openclaw-builds/restaurant-staff-scheduling-compliance
model: gpt-5.3-codex
provider: openai
approval: never
